            ...
            <View style={styles.wrapper}>
                <View style={styles.container}>
                    ...
                    <View style={styles.bottomContainer}>
                        <Text style={styles.dealingAmountText}>{`已${tradeTypeStr}`}<Text style={styles.dealingAmountTextPart}>{`  ${this.props.item.dealingAmount} ${this.props.item.token}`}</Text></Text>
